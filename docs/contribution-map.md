...
2. Add a heavier opt-in DDBJ CHM13 100k/full-tier path or a second public human FORMAT-rich source, then add optional GATK/VCFtools comparisons before broadening claims beyond the sheep/cattle/human public evidence.
