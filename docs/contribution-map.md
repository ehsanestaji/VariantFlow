...
3. Tune auto BGZF and predicate scheduler caps from full repeated public rows; keep site-only filters single-threaded by default unless public evidence proves a safe broader default.
