...
4. Expand v1.1 Parallel Native Execution to public-heavy BGZF and 1M CPU-heavy expression rows, then decide whether to invest in BGZF block-aware scheduling or parallel output compression.
