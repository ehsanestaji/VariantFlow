...
| Human FORMAT-rich cohort | beats on measured bounded 3715-sample human rows | `benchmark/reports/v20-human-format-cohort.md` reports matched core records on DDBJ CHM13 chr22; 1000-record DP/GQ/AD/selected-sample/mixed FORMAT rows were 6.45x to 12.67x faster than `bcftools filter` | bcftools | bounded streaming tier only; full 27 GB VCF is not cached by default |
