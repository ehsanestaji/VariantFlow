...
ROWS = [
    ...
    Row(
        ...
        dataset="DDBJ CHM13 chr22 3715-sample human VCF, bounded 1000-record tier",
        correctness="matched bcftools core records",
        measured_result="6.45x to 12.67x faster than bcftools filter across DP/GQ/AD/selected-sample/mixed FORMAT expressions",
        ...
        caveat="bounded streaming tier only; full 27 GB remote VCF is not cached by default",
    ),
    Row(
