...
ROWS = [
    ...
    Row(
        ...
        correctness="default and indexed outputs matched byte-for-byte; indexed core records matched bcftools",
        measured_result="3.13x to 3.69x faster than bcftools, but slower than default native on measured rows",
        ...
        required_tokens=(
            ...
            "3.13x vs bcftools",
            "3.28x vs bcftools",
            "slower than default native",
            "indexed 8896 KB",
        ),
        caveat="public AF predicate skipped only 0.0% to 50.0% of chunks; index acceleration needs high-skip predicates or deeper BGZF scheduling",
    ),
    Row(
