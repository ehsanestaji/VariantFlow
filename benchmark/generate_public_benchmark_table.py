...
ROWS = [
    ...
    Row(
        ...
        correctness="default and indexed outputs matched byte-for-byte; indexed core records matched bcftools",
        measured_result="focused v3.0 100k `AF > 0.99` row with chunk target 256 skipped 89.8% of chunks and measured 4.87x faster than bcftools",
        ...
        caveat="focused single-run row; full 100k/1M public matrix remains deferred",
    ),
    Row(
