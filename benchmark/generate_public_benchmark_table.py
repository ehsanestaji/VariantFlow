...
ROWS = [
    ...
    Row(
        ...
        measured_result="1.47x to 8.28x faster than VCFtools across frequency, missingness, HWE, heterozygosity, site/window pi, Tajima's D, LD, and Weir-Cockerham Fst",
