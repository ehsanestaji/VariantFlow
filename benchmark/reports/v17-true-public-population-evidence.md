...
|---|---|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---|---|---|
| public cohort 10000 | all cases | pending | pending | official population metadata required | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | not measured |
| public cohort 50000 | all cases | pending | pending | official population metadata required | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | not measured |
| public cohort 100000 | all cases | pending | pending | official population metadata required | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | not measured |
