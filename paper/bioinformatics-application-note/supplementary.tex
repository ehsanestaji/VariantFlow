...
\large VariantFlow: selective execution for VCF filtering,\\
population summaries, and analytical export}
...
set size. Speedups quoted in the main text are baseline/VF wall-clock ratios.}
\end{table}
