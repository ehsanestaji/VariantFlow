...
workflows in Supplementary Table~S3. Population-genetic benchmarks were run on
an Apple M5 Max workstation and the index-assisted and columnar benchmarks on a
Docker/Linux host; within every comparison both tools were run on the same host,
so no ratio spans machines.
